...
<div class="container-fluid pt-5">
    <div class="row">
        ...
        <div class="col-md-9 p-5">
                ...
                <div class="row">
                  <div class="col-sm-*">
                    <p>
                        ...
                        doloremque unde cum tempora ipsum vel, autem totam reprehenderit 
            ...
            <div class="row">
                <div class="col-sm-4 p_priest portriat">Rev. Fr. Gilbert Fagbemi</div>
                <div class="col-sm-4 a_priest portriat">Rev. Fr. John Igbah</div>
                <div class="col-sm-4 catechist portriat">Cat. Micheal Iheme</div>
            </div>
        </div>
    </div>
</div>
